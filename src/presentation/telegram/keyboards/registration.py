...
from src.presentation.telegram.keyboards.main_menu import BACK_BUTTON
from src.presentation.telegram.ui_texts import CATEGORY_LABEL_TO_CODE, LOYALTY_OPTIONS
