...
class ConversationState(str, Enum):
    ...
    AWAIT_NOTIFICATION_GROUP = "await_notification_group"
    AWAIT_NOTIFICATION_CATEGORY = "await_notification_category"
    AWAIT_NOTIFICATION_PERIOD = "await_notification_period"
